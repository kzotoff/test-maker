...
const Translator = function() {
    ...
    this.translations = {
        "en": {
            ...
            "css-prop-color": "Text color",
            "css-prop-font-size": "Text size",
            ...
            "audio-hightlight-source": "Audio highlight as source",
            "audio-hightlight-target": "Audio highlight as target",
            ...
            "solution-correct-play-sound": "Play sound when correct",
            "save-as": "Save as",
            "saved-as": "Saved as",
            "load-as": "Load",
        ...
        "ru": {
            ...
            "page-arrow-width": "Толщина стрелки",
            ...
            "audio-hightlight-source": "Подсветка начала стрелки при звуке",
            "audio-hightlight-target": "Подсветка окончания стрелки при звуке",
            ...
            "solution-correct-play-sound": "При решении играть звук",
